...
function Splash({ go }) {
  return (<div style={{ height: "100%", background: `linear-gradient(168deg, ${B.black} 0%, #151725 55%, ${B.charcoal} 100%)`, display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "50px 24px 32px", position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      <button onClick={() => go("buyer")} style={{ width: "100%", padding: "16px", background: B.gold, border: "none", borderRadius: 14, fontSize: 15, fontWeight: 700, color: B.black, cursor: "pointer", fontFamily: "inherit" }}>I'm looking to buy a home</button>
      <button onClick={() => go("quiz")} style={{ width: "100%", padding: "15px", background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.14)", borderRadius: 14, fontSize: 15, fontWeight: 600, color: B.white, cursor: "pointer", fontFamily: "inherit" }}>I'm relocating — find my neighborhood</button>
